...
const githubAuthUrl = `https://github.com/login/oauth/authorize?client_id=${process.env.NEXT_PUBLIC_GITHUB_CLIENT_ID}&scope=user:email read:org repo&redirect_uri=http://localhost:8080/api/auth/github/callback`;
